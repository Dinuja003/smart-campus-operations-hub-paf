...
import { d as getParentNode, g as isLastTraversableNode, h as isHTMLElement, r as useStableCallback, t as useIsoLayoutEffect } from "./useIsoLayoutEffect-Cyv1OqIi.js";
import { a as POPUP_COLLISION_AVOIDANCE, c as EMPTY_OBJECT, d as useMergedRefs, f as useRefWithInit, i as DROPDOWN_COLLISION_AVOIDANCE, s as EMPTY_ARRAY, t as useRenderElement } from "./useRenderElement-J75pqNiS.js";
import { n as useCompositeRootContext, t as useButton } from "./useButton-CDK5_69x.js";
import { r as mergeProps } from "./merge-props-Ds6n4FlT.js";
import { C as FloatingTree, Ct as popupStateMapping, D as FloatingTreeStore, E as useFloatingTree, Et as transitionStatusMapping, F as useValueAsRef, I as getNextTabbable, M as FocusGuard, O as FloatingPortal, R as getTabbableAfterElement, S as FloatingNode, T as useFloatingParentNodeId, Tt as triggerOpenStateMapping, V as isOutsideEvent, _ as fastComponent, a as createInitialPopupStoreState, b as useDismiss, c as useImplicitActiveTrigger, d as useTriggerRegistration, f as useOpenChangeComplete, g as ReactStore, ht as stopEvent, i as useSyncedFloatingRootContext, l as useOpenStateTransitions, m as useTransitionStatus, mt as isVirtualPointerEvent, n as inertValue, o as popupStoreSelectors, p as useAnimationsFinished, pt as isVirtualClick, r as useInteractions, s as PopupTriggerMap, t as useOnFirstRender, u as useTriggerDataForwarding, v as fastComponentRef, w as useFloatingNodeId, wt as pressableTriggerOpenStateMapping, y as createSelector, yt as useTimeout, z as getTabbableBeforeElement } from "./useOnFirstRender-Bc0Tr6Tg.js";
import { C as isMac, D as useId, E as useBaseUiId, F as itemPress, I as listNavigation, N as focusOut, O as createChangeEventDetails, P as imperativeAction, a as getTarget, g as ARROW_UP, h as ARROW_RIGHT, i as getFloatingFocusElement, k as cancelOpen, l as isTypeableCombobox, m as ARROW_LEFT, n as activeElement, p as ARROW_DOWN, r as contains, t as ownerDocument, z as siblingOpen } from "./owner-BY9JXFf1.js";
import { _ as isIndexOutOfListBounds, a as useRole, c as enqueueFocus, d as getGridCellIndexOfCorner, f as getGridCellIndices, g as isElementVisible, h as getMinListIndex, i as COMPOSITE_KEYS, l as createGridCellMap, m as getMaxListIndex, n as useScrollLock, o as useClick, p as getGridNavigatedIndex, r as InternalBackdrop, s as FloatingFocusManager, t as useOpenInteractionType, u as findNonDisabledListIndex, v as isListIndexDisabled } from "./useOpenInteractionType-Bem0FSnP.js";
import { a as getDisabledMountTransitionStyles, c as useHoverFloatingInteraction, i as useDirection, l as useFocus, n as useAnchorPositioning, o as safePolygon, r as adaptiveOrigin, s as useHoverReferenceInteraction, t as usePopupViewport } from "./usePopupViewport-CfZ5M3nM.js";
import { t as useControlled } from "./useControlled-a6PHLMxe.js";
import { t as Separator } from "./Separator-BUad-0vH.js";
...
var MenuLinkItem = /* @__PURE__ */ import_react.forwardRef(function MenuLinkItem(componentProps, forwardedRef) {
	...
	return useRenderElement("a", componentProps, {
		state: import_react.useMemo(() => ({ highlighted }), [highlighted]),
		props: [
			itemProps,
			elementProps,
			getItemProps
